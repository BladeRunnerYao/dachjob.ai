...
class Settings(BaseSettings):
    ...
    vertex_ai_model_fast: str = "google/gemini-2.5-flash-lite"
    vertex_ai_model_quality: str = "google/gemini-2.5-flash"
    vertex_ai_model_reasoning: str = "google/gemini-2.5-pro"
